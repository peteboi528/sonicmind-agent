...
def _patch_urlopen(monkeypatch, payload):
    ...
    monkeypatch.setattr(
        musicbrainz_client.urllib.request,
        "urlopen",
            ...
            "relations": [
                {
                    "target-type": "url",
                    "type": "review",
                    "url": {"resource": "https://www.bbc.co.uk/music/reviews/wcp2"},
                },
            ...
            "relations": [
                {
                    ...
                    "type": "BBC Music page",
                    "ended": True,
                    "url": {"resource": "https://www.bbc.co.uk/music/artists/artist1"},
                },
            ],
        },
    )
