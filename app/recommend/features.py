...
GENRE_TEMPO_BPM: dict[str, int] = {
    # 流行
    "流行": 115, "华语流行": 112, "欧美流行": 118, "韩流": 120, "日系流行": 122,
    "City Pop": 105, "合成器流行": 118,
    # 摇滚
    "摇滚": 125, "英伦摇滚": 130, "独立摇滚": 130, "朋克": 170, "后摇": 120,
    "盯鞋": 110, "硬摇滚": 140, "后朋克": 145,
    # 电子
    "电子": 124, "House": 124, "Techno": 130, "氛围电子": 85, "未来贝斯": 150, "synthwave": 110,
    # 说唱
    "说唱": 95, "中文说唱": 92, "欧美说唱": 95, "Trap": 140, "Drill": 145,
    # R&B / soul
    "R&B": 90, "新灵魂": 88, "另类R&B": 92, "放克": 105,
    # 其他常见
    "独立": 110, "氛围": 80, "lo-fi": 82, "原声": 95, "世界音乐": 100, "拉丁": 100,
    "雷鬼": 75, "蓝调": 90, "乡村": 100, "古风": 85, "实验": 110,
    "爵士": 100, "金属": 150, "古典": 90, "民谣": 95, "国风": 85,
}

# ── mood → energy（0..1）───────────────────────────────────────────────────
# mood 本身编码了情绪/能量，因此语义上最可信。覆盖观测到的 mood + _MOOD_RULES 全集。
MOOD_ENERGY: dict[str, float] = {
    "激昂": 0.85, "热血": 0.88, "律动": 0.70, "欢快": 0.65, "励志": 0.62,
    "性感": 0.55, "暗黑": 0.55, "浪漫": 0.50, "梦幻": 0.40, "治愈": 0.35,
    "伤感": 0.30, "孤独": 0.28, "放松": 0.30, "慵懒": 0.25, "宁静": 0.22,
}
...
def estimate_features(
    genres: list[str] | None, moods: list[str] | None
