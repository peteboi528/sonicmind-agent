...
def test_playlist_keeps_only_real_songs_and_recounts():
    ...
    tracks = [
        ...
        _t("Blinding Lights", "The Weeknd"),
        _t("Levitating", "Dua Lipa"),
        _t("As It Was", "Harry Styles"),
        _t("Anti-Hero", "Taylor Swift"),
        _t("Flowers", "Miley Cyrus"),
        _t("Unholy", "Sam Smith"),
        _t("Calm Down", "Rema"),
        _t("Cruel Summer", "Taylor Swift"),
        _t("Vampire", "Olivia Rodrigo"),
        # 脏数据
