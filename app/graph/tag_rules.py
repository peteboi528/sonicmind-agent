...
_ARTIST_GENRE_HINTS: dict[str, list[str]] = {
    # ── 欧美说唱 / Hip-Hop ──（细分到欧美说唱，父类「说唱」可由 genres.parent_genre 上卷）
    "drake": ["欧美说唱", "R&B"],
    "kendrick lamar": ["欧美说唱"],
    "j. cole": ["欧美说唱"],
    "travis scott": ["欧美说唱", "Trap"],
    "post malone": ["欧美说唱", "流行"],
    "kanye west": ["欧美说唱"],
    "eminem": ["欧美说唱"],
    "jay-z": ["欧美说唱"],
    ...
    "bonobo": ["电子"],
    "jamie xx": ["电子"],
    # ── 摇滚（细分到英伦/独立，父类「摇滚」可由 genres.parent_genre 上卷）──
    "coldplay": ["英伦摇滚", "流行"],
    ...
    "paramore": ["摇滚"],
    "green day": ["朋克"],
    "red hot chili peppers": ["硬摇滚"],
    "the strokes": ["独立摇滚"],
    "my bloody valentine": ["盯鞋"],
    "slowdive": ["盯鞋"],
    "tame impala": ["独立摇滚", "电子"],
    "mgmt": ["独立摇滚", "电子"],
    # ── 流行 ──
